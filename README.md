...
Этот файл содержит настройки для развертывания UnicArch, Nginx и Keycloak. Заполните его перед запуском скриптов. Все пароли должны быть надежными. Не коммитьте файл в Git.
